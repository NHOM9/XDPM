...
public class Sprite2D {
	 ...
	 * @param positionY
	 */
	public Sprite2D(String pathDir, String pathImage,
			int bufferSizeWidth, int bufferSizeHeight, 
			float positionX, float positionY,
			int rectangleWidth, int rectangleHeight
			)
	{
		this._PathDirectoryImage = pathDir;
		this._PathFileImage = pathImage;
		this._BufferSizeWidth = bufferSizeWidth;
		this._BufferSizeHeight = bufferSizeHeight;
		this._PositionX = positionX;
		this._PositionY = positionY;
		this.RectangleWidth = rectangleWidth;
		this.RectangleHeight = rectangleHeight;
		//this.typeEntity = nameOfTypeEntity;
	}
